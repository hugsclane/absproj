...
// APIClient manages communication with the ABS Data API (Beta) API v0.2.0
...
type APIClient struct {
	...
	GetDataAPI *GetDataAPIService

	GetMetadataAPI *GetMetadataAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.GetDataAPI = (*GetDataAPIService)(&c.common)
	c.GetMetadataAPI = (*GetMetadataAPIService)(&c.common)
